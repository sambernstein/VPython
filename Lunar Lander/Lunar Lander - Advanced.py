...
class SegmentPoly(object):
    def __init__(self, start=None, c_3=None, c_2=None, c_1=None, b=None, platform=None):
        self.start = start
        self.c_3 = c_3
        self.c_2 = c_2
        self.c_1 = c_1
        self.b = b
        self.platform = platform  # boolean

def surfacePoly(f, lander_x): # must plug in lander.pos.x

    x = lander_x - f.start
    y = f.c_3*(x^3) + f.c_2*(x^2) + f.c_1*x + f.b

    return y  # returns the y value of the lunar surface at the point where the lander is
