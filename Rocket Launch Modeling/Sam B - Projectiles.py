...
# simulations screen
screen = display(x = 0, width = 800, height = 650, center = (0,1.5,0), title = "Air Resistance and Projectile Motion")
...
n = 0
angle_list = [6*a for a in range(1,15)] # 5 degrees to 85 degrees
notch_list = [2*s for s in range(1,5)]
...
notch_list = [s for s in range(1,10)]
notch_h = []
angle_list = [9*a for a in range(1,10)] # 5 degrees to 85 degrees
